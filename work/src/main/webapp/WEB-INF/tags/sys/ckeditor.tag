...
<%@ attribute name="toolbarStartupExpanded" type="java.lang.Boolean" required="false" description="工具栏默认是否展开"%>
...
<script type="text/javascript">
	...
	if("${toolbarStartupExpanded}"!=null&&"${toolbarStartupExpanded}"!=""){
		if("${toolbarStartupExpanded}"=="true"){
			${replace}Ckeditor.config.toolbarStartupExpanded = true;
		}
		if("${toolbarStartupExpanded}"=="false"){
