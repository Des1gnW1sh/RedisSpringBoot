...
<head>
	...
	<script type="text/javascript">
		...
		var path=	"E:\\JavaProject\\FiscalManage\\intellectreport\\demo\\1.xls";
		alert(path);
			 //查询事件
	        $("#btnExcel").click(function () {
	        	 $.ajax({
	                 url: "${ctx}/test/testData/GetTableFiledListJson",	   
	                 data:{"path":path},	                
	                 async: false,
	        ...
	        $("#btn1").click(function () {
	        	 $.ajax({
	                 url: "${ctx}/test/testData/GetTableFiledJson",	   
	                 data:{"path":path},	                
	                 async: false,
	                 success: function (data) {
	                   alert("成功");
...
<body>
	...
	<form:form id="searchForm" modelAttribute="testData" action="${ctx}/test/testData/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnExcel" class="btn btn-primary" type="button"  value="excel操作"/></li>
			<li class="btns"><input id="btn1" class="btn btn-primary" type="button"  value="excel操作1"/></li>
