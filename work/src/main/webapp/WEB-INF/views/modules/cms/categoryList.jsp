...
<body>
	...
	<shiro:hasPermission name="cms:category:edit">
		<a  class="btn btn-primary"    href="javascript:void(0);"onclick="contentSave('${ctx}/cms/category/form','新增',800,530)" ><i class="icon-add"></i>新增</a>
	</shiro:hasPermission>
			...
			<c:forEach items="${list}" var="tpl">
				<tr id="${tpl.id}" pId="${tpl.parent.id ne '1'?tpl.parent.id:'0'}">
					...
					<td>
						...
						<shiro:hasPermission name="cms:category:edit">
							<a href="JavaScript:void(0)" onclick="contentUpdate('${ctx}/cms/category/form?id=${tpl.id}','修改',800,530)">修改</a>
							<a href="${ctx}/cms/category/delete?id=${tpl.id}" onclick="return confirmx('要删除该栏目及所有子栏目项吗？', this.href)">删除</a>
							<a href="JavaScript:void(0)" onclick="contentUpdate('${ctx}/cms/category/form?parent.id=${tpl.id}','添加下级栏目',800,530)">添加下级栏目</a>
						</shiro:hasPermission>
					</td>
				</tr>
			</c:forEach>
