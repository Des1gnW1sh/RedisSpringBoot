...
import com.scnjwh.intellectreport.modules.cms.dao.ArticleDao;
import com.scnjwh.intellectreport.modules.cms.dao.ArticleDataDao;
import com.scnjwh.intellectreport.modules.cms.dao.CategoryDao;
...
//		return dao.find(page, dc);
	...
	public void save(Article article) {
		...
		if (StringUtils.isBlank(article.getId())){
			...
			try {
				solr.add(article.getId(), article.getTitle(), articleData.getContent());
