 ...
 */
package com.scnjwh.intellectreport.modules.gen.entity;
...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	public String getDataLength() {
		String[] ss = StringUtils.split(
				StringUtils.substringBetween(getJdbcType(), "(", ")"), ",");
	...
	public String getSimpleJavaType() {
		...
		return StringUtils.indexOf(getJavaType(), ".") != -1 ? StringUtils
	...
	public String[][] getJavaFieldAttrs() {
		String[] ss = StringUtils.split(
				StringUtils.substringAfter(getJavaField(), "|"), "|");
