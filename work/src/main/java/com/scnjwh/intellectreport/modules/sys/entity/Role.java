...
public class Role extends DataEntity<Role> {
	...
	private SysUserGroup sysGroup; //角色组管理

	// private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	private List<Menu> menuList = Lists.newArrayList(); // 拥有菜单列表
	private List<Office> officeList = Lists.newArrayList(); // 按明细设置数据范围
	private List<RuleDefinition> ruleList= Lists.newArrayList();//数据规则权限范围
 ...
 * 
 	...
 	public List<Menu> getMenuDataList() {
		return menuList;
	}

	public void setMenuDataList(List<Menu> menuList) {
		this.menuList = menuList;
	}
 	public String getMenuIds() {
		return StringUtils.join(getMenuIdList(), ",");
	...
	public void setRuleList(List<RuleDefinition> ruleList) {
		this.ruleList = ruleList;
	}
	
	public String  getRuleIds() {
		return StringUtils.join(getRuleList(), ",");
	}
