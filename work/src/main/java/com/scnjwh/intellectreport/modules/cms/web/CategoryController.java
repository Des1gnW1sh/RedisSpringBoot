...
public class CategoryController extends BaseController {
	...
	public String form(Category category, Model model) {
        ...
        model.addAttribute("listViewList",getTplContent(Category.DEFAULT_TEMPLATE));//自定义列表视图  --frontList
        model.addAttribute("category_DEFAULT_TEMPLATE",Category.DEFAULT_TEMPLATE);//自定义列表视图名称必须以"frontList"开始
        model.addAttribute("contentViewList",getTplContent(Article.DEFAULT_TEMPLATE));//自定义内容视图
        model.addAttribute("article_DEFAULT_TEMPLATE",Article.DEFAULT_TEMPLATE);//自定义内容视图名称必须以"frontViewArticle"开始
	...
	@ResponseBody
	public String save(Category category, Model model,  HttpServletResponse response) {
...
//		}
		...
		return  renderString(response, new AjaxJson().setMsg("保存栏目"+category.getName()+"成功"));
