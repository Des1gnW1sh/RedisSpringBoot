...
import com.scnjwh.intellectreport.modules.cms.entity.FileTpl;
...
/**
 * User: songlai Date: 13-8-27 Time: 下午4:56
 */
@Service
...
public class FileTplService {
	...
	public List<FileTpl> getListForEdit(String path) {
		...
		result.add(new FileTpl(new File(context.getRealPath(path)), context
				.getRealPath("")));
