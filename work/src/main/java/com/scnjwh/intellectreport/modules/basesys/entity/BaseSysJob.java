 ...
 * @version 2017-04-20
 */
public class BaseSysJob extends DataEntity<BaseSysJob> {

	private static final long serialVersionUID = 1L;
	private String name; // 岗位名称
	private Office office; // 所在公司
	...
	public BaseSysJob(String id) {
		super(id);
	}

	@Length(min = 1, max = 255, message = "岗位名称长度必须介于 1 和 255 之间")
	...
	@Length(min = 1, max = 60, message = "岗位编号长度必须介于 1 和 60 之间")
