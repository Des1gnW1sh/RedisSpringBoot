 ...
 */
package com.scnjwh.intellectreport.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.scnjwh.intellectreport.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.scnjwh.intellectreport.modules.sys.entity.User(null, userId)))){
