...
public class ActProcessService extends BaseService {
	...
	public Page<Object[]> processList(Page<Object[]> page, String category) {
		...
		ProcessDefinitionQuery processDefinitionQuery = repositoryService
				...
				.orderByProcessDefinitionCategory().desc();
		...
		for (ProcessDefinition processDefinition : processDefinitionList) {
			...
			Deployment deployment = repositoryService.createDeploymentQuery()
					.deploymentId(deploymentId).orderByDeploymenTime().desc()
					.singleResult();
	 ...
	 * @param procDefId
	 * @return
	 * @Author : pengjunhao. create at 2017年5月19日 下午3:12:13
	 */
	public int validateDelete(String procDefId) {
		return actDao.validateDelete(procDefId);
	}
