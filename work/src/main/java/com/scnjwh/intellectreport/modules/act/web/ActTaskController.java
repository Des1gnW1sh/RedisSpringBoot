...
import com.scnjwh.intellectreport.modules.act.service.ActTaskService;
...
public class ActTaskController extends BaseController {
	...
	@ResponseBody
	public String todoData(Act act, HttpServletResponse response, Model model)
			throws Exception {
		List<Act> list = actTaskService.todoList(act);
		return renderString(response, list);
	}
	...
	@ResponseBody
	public String  historicData(Act act, HttpServletRequest request,
			HttpServletResponse response, Model model) throws Exception {
		Page<Act> page = new Page<Act>(request, response);
		page = actTaskService.historicList(page, act);
		return renderString(response, page);
	 ...
	 *            vars.types=S,B @see
	 *            com.scnjwh.intellectreport.modules.act.utils.PropertyType
	 */
