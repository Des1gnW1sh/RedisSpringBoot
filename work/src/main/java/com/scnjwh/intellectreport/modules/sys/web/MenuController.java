...
public class MenuController extends BaseController {
	...
	@ResponseBody
	public String save(Menu menu,Model model, HttpServletResponse response) {
		if (!UserUtils.getUser().isAdmin()) {
			return renderString(response, new AjaxJson().setMsg("越权操作，只有超级管理员才能添加或修改数据！").setSuccess(false));
		...
		return renderString(response, new AjaxJson().setMsg("保存菜单成功"));
	...
	@RequestMapping(value = "toHelpDocment")
	public String toHelpDocment(){
		return "modules/helpdoc/document";
	}
}
