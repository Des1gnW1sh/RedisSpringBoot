...
import com.scnjwh.intellectreport.test.entity.TestDataMain;
import com.scnjwh.intellectreport.test.dao.TestDataMainDao;
import com.scnjwh.intellectreport.test.entity.TestDataChild;
import com.scnjwh.intellectreport.test.dao.TestDataChildDao;
...
public class TestDataMainService extends
		CrudService<TestDataMainDao, TestDataMain> {
	...
	public Page<TestDataMain> findPage(Page<TestDataMain> page,
			TestDataMain testDataMain) {
	...
	public void save(TestDataMain testDataMain) {
		...
		for (TestDataChild testDataChild : testDataMain.getTestDataChildList()) {
			...
			if (TestDataChild.DEL_FLAG_NORMAL
					.equals(testDataChild.getDelFlag())) {
