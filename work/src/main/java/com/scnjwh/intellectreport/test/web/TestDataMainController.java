...
import com.scnjwh.intellectreport.test.service.TestDataMainService;
...
public class TestDataMainController extends BaseController {
	...
	public String list(TestDataMain testDataMain, HttpServletRequest request,
			HttpServletResponse response, Model model) {
		Page<TestDataMain> page = testDataMainService.findPage(
				new Page<TestDataMain>(request, response), testDataMain);
	...
	public String save(TestDataMain testDataMain, Model model,
