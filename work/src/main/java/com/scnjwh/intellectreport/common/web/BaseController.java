...
public abstract class BaseController {
	...
	protected String resultString(HttpServletResponse response, Object object) {
		return resultString(response, JsonMapper.toJsonString(object),
	...
	protected String resultString(HttpServletResponse response, String string,
			String type) {
		try {
			response.reset();
			response.setContentType(type);
